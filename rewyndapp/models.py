...
class Tweet(models.Model):
    ...
    has_media = models.BooleanField(null=False, default=False)
    media_type = models.CharField(max_length=40, null=True)
    media_image_url = models.URLField(max_length=250, null=True)
    result_type = models.CharField(max_length=40, default="None")
